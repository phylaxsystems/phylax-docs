...
description: 'How to get started monitoring smart contracts with the Phylax Monitor'
---
TODO: This doc should be moved to the phylax-monitor repo eventually and updated once final install instructions are available
## Prerequisites
