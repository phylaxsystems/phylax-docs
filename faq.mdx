...
Welcome to the Phylax Credible Layer FAQ! Here you'll find answers to common questions about PCL's 
...
You can think of it as an inverse intent. You define something you don't want to happen without specifying or caring about all the edge cases that could lead to it.
...
Invariants are properties of your protocol that must always remain true. They are fundamental to the Credible Layer's approach to security:
