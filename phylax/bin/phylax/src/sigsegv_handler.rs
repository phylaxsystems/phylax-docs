...
//!
//! Implementation modified from [`rustc`](https://github.com/rust-lang/rust/blob/3dee9775a8c94e701a08f7b2df2c444f353d8699/compiler/rustc_driver_impl/src/signal_handler.rs), by the Reth team (https://github.com/paradigmxyz/reth/blob/d4ff65bfadb98c72378c6f94118ef51ec4c1e580/bin/reth/src/sigsegv_handler.rs)
...
extern "C" fn print_stack_trace(_: libc::c_int) {
    ...
    raw_errln!("error: phylax interrupted by SIGSEGV, printing backtrace\n");
    let mut written = 1;
    let mut consumed = 0;
    ...
    if cyclic || stack.len() > random_depth() {
        ...
        raw_errln!("note: phylax unexpectedly overflowed its stack! this is a bug");
        written += 1;
    }
    ...
    raw_errln!("note: we would appreciate a report at https://github.com/phylaxsystems/phylax");
    written += 1;
    if written > 24 {
