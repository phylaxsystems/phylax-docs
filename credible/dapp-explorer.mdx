...
Explorer is designed to help users inspect protocol security information without reducing it to a score.

For each public project, Explorer can show the protections that are active, the contracts they apply to, the actions they check, and the unsafe conditions they are meant to prevent. Where supporting evidence is available, Explorer can also show admin and upgrade information, audit links, and deployed-vs-audited code context.
...
For more detail, see [Security Posture in Phylax Explorer](/credible/explorer-security-posture).
