...
3. **Submission**: Submit the assertion ID to your project in the [Phylax platform](https://app.phylax.systems) using `pcl submit`
...
5. **Marked for Enforcement/Staging**: After the add transaction is accepted on-chain, the State Oracle timelock begins. During that period, the assertion is marked for enforcement (production) or marked for staging (staging environment)
