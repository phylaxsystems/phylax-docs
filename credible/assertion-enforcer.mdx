...
The Assertion Enforcer integrates with block builders so that the network can apply assertion-validation results during block production:

- The block builder or sequencer receives validation results for candidate transactions
