...
<Note>
The starter repository provides the project structure used in this tutorial. Its existing ownership example uses the legacy trigger and snapshot APIs; replace it with the Reshiram-based assertion shown below rather than treating it as the finished version of this tutorial.
</Note>
...
<CardGroup cols={2}>
  <Card title="Apply Assertions" icon="upload" href="/credible/apply-assertions">
    Create an assertion release with `pcl apply`
  </Card>
