...
<Note>
    ...
    Specfic instructions can be found in the [README](https://github.com/phylaxsystems/credible-layer-starter/blob/main/README.md).
</Note>
...
- `<INITIAL_OWNER_ADDRESS>`: The address of the initial owner of the contract, it makes sense to use the address of the account you used to sign in to the dApp
...
We are aware of this and a fix will be released in a future version. For now we recommend doing a simple ether transfer with a higher gas price, to replace the reverted transaction.
