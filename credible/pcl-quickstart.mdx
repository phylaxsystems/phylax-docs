...
We are aware of this and a fix will be released in a future version.
For now we recommend doing a simple ether transfer with a higher gas price, to replace the reverted transaction:
