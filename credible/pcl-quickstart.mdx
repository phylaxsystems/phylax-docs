...
7. Deploy your assertion with `pcl apply`
...
This will provide you with a URL and an authentication code. You can authenticate via wallet or email.
...
## 7. Deploy Your Assertion

Deploy your assertion to the platform with a single command:
...
You'll be prompted to confirm the deployment. After confirmation, `pcl apply` returns a release number and a link to review the release in the platform.

<Note>
If `project_id` is not set in your `credible.toml`, you'll be prompted to select a project interactively. You can also specify it with the project name you created in step 5.
</Note>

## 8. Review and Activate Your Assertion

Open the platform at [app.phylax.systems](https://app.phylax.systems) and navigate to the project that the assertion was added to.
