---
title: 'Quickstart'
description: 'A quickstart guide to writing assertions and using the Credible Layer CLI (reminder that is pretains to local deployments only)'
---
...
5. Create a project
6. Store your assertion to the assertion DA
...
Congratulations! You've successfully created, tested, activated and verified your first assertion using the Credible Layer CLI. 
