...
<Note>
If you already know the overall flow and only need one task, use the dedicated guides for [installation](./credible-install), [storing and submitting assertions](./store-submit-assertions), or [deployment in the platform](./deploy-assertions-dapp).
</Note>
...
To finish the tutorial, open the platform at [app.phylax.systems](https://app.phylax.systems) and navigate to the project that the assertion was added to.
