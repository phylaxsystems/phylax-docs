---
title: 'Quickstart'
description: 'A quickstart guide to writing assertions and using `pcl`'
---

## Introduction

This guide will walk you through the process of creating, testing, and submitting an assertion using `pcl`. By the end of this tutorial, you'll understand how to:
...
- `pcl` installed (see the [Installation Guide](/credible/credible-install))
...
For a detailed understanding of what an assertion is and how it works, see the [Assertion Guide](/credible/write-first-assertion). For testing assertions, see the [Testing Assertions](/credible/testing-assertions) guide.
...
For a more detailed overview of how to use the dApp and manage projects, see the [Deploy Assertions guide](/credible/deploy-assertions-dapp).
...
Last step is to go to the dApp and deploy the assertion. Go back to the url that you opened with the `pcl auth login` command and navigate to the project that the assertion was added to. 
...
For more detailed information about `pcl` and its commands, see [Store and Submit Assertions](/credible/store-submit-assertions) and [pcl Reference](/credible/cli-reference).
