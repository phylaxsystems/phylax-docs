...
Another way to install `pcl` is using Cargo. It requires:

- **rustup**
- **Git**

```bash
cargo +nightly-2026-01-07 install --git https://github.com/phylaxsystems/pcl --locked pcl
```
...
2. Build the CLI:
   ```bash
   cargo build --release --package pcl
   ```
