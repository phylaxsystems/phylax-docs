...
The OP Stack implementation uses a **Rollup-Boost Pattern** that connects external sidecar assertion validation components with the L2 sequencer through a bridge proxy.
...
The Rollup-Boost pattern provides several advantages for OP Stack networks:
