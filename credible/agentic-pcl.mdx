...
```bash Codex
npx github:phylaxsystems/agent-skills install pcl-assertion-workflow --agent codex
npx github:phylaxsystems/agent-skills install deploy-credible-assertions --agent codex
```

```bash Claude Code
npx github:phylaxsystems/agent-skills install pcl-assertion-workflow --agent claude-code
npx github:phylaxsystems/agent-skills install deploy-credible-assertions --agent claude-code
```
