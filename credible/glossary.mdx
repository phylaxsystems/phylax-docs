...
Special transactions that may have protocol-level inclusion guarantees, such as L1->L2 deposits. These require network-specific handling because the normal block-building rejection path may not be sufficient.
