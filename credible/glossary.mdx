...
### Apply
The process of deploying assertions to the platform using `pcl apply`. This command reads your `credible.toml` configuration, compiles assertion contracts, and creates a release on the platform. The platform handles storing assertion bytecode in [Assertion DA](/credible/glossary#assertion-da-data-availability) automatically.
