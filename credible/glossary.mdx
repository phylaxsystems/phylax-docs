...
### Submit
The process of submitting an assertion contract to a project in the Phylax platform using `pcl submit`. After storing, assertions must be submitted to a project before they can be deployed.
