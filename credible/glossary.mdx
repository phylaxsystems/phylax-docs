...
A signature generated and returned by the Assertion DA as part of storing an assertion. This proof is used during on-chain registration of the assertion to guarantee that the assertion bytecode is available on the Assertion DA.
