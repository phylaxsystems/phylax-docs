...
### Phylax Explorer
A public interface for browsing projects, protected contracts, active assertions, protection summaries, operational risk cards, deployed-vs-audited code context, evidence links, raw data views, and limited invalidation metadata where available. Detailed project management data, staging invalidations, transaction payloads, and traces are only available in private project views.
