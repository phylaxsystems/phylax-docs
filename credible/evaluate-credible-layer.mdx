...
description: 'A quick checklist for protocol teams and networks evaluating Credible Layer'
---
...
<CardGroup cols={2}>
  <Card title="Platform Integration" icon="browser" href="/credible/dapp-integration">
