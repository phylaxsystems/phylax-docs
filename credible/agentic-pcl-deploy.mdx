...
- The selected environment and chain
- The project that will be created or reused
- The protected contract addresses
- The assertions and constructor arguments
- The wallet expected to act as protocol manager
- Any warnings or failed verification

Do not continue if the dry run differs from your intended deployment.
...
<CardGroup cols={2}>
  <Card title="pcl Reference" icon="terminal" href="./cli-reference">
