...
- The only entity that can re-enable registration is an address provided by the platform at the time of blacklisting. This escape hatch allows protocols to opt out of Phylax while preserving the option to opt back in later
