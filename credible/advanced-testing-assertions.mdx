...
For concrete examples of how to use backtesting, see the [backtesting test examples](https://github.com/phylaxsystems/credible-std/tree/master/test/backtesting).
