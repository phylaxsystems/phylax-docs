...
By default, invalidation details are private to the project team. This prevents potentially exploitable details from being exposed to unrelated users while still allowing the project team to debug false positives and investigate true positives.
