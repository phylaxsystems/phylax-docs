...
Function call input mappings describe how assertions can inspect call data for a target function and compare the resulting state transition against expected behavior.
