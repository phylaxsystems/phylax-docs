...
You can see an exampple of how to use this cheatcode in the [Storage Lookups](/credible/use-case-mappings/storage-lookups) use case mapping.
...
You can see an exampple of how to use this cheatcode in the [Read Logs](/credible/use-case-mappings/read-logs) use case mapping.
...
You can see an exampple of how to use this cheatcode in the [Function Call Inputs](/credible/use-case-mappings/function-call-inputs) use case mapping.
...
You can see an exampple of how to use this cheatcode in the [State Changes](/credible/use-case-mappings/state-changes) use case mapping.
