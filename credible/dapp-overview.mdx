...
The [Phylax Explorer](/credible/dapp-explorer) provides public visibility into projects and their assertions. Browse, search, and review which protocols are protected and how.
...
To use project management features, sign in to the platform. For CLI operations such as `pcl apply`, authenticate [`pcl`](/credible/cli-reference#auth) through the same account. The platform supports authentication via wallet, email, Google, or GitHub.
