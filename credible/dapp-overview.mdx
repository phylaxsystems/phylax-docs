...
When you create a project and deploy assertions through the platform, those assertions are deployed on-chain. Block builders or sequencers use this registry to validate transactions against your assertions before including them in blocks.
