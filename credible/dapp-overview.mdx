...
<Frame caption="The Phylax Explorer projects page">
  <img src="/images/phylax-explorer-projects.png" alt="The Phylax Explorer projects page showing public projects, saved projects, search, and network labels" />
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Security Posture in The Phylax Explorer" icon="shield-check" href="/credible/explorer-security-posture">
