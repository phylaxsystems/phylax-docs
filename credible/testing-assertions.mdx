...
<Note>
For the higher-level testing philosophy, see [Testing Strategy](./testing-strategy). For historical transaction configuration fields, see the [Backtesting Reference](./backtesting-reference).
</Note>
