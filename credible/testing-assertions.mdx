...
<Note>
For the higher-level testing workflow, see [How to Plan Assertion Testing](./testing-strategy). After your local tests pass, create a release and review its [automatic platform backtest](./backtesting).
</Note>
