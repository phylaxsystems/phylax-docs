...
flowchart LR
    ...
    classDef state fill:#ffe0e0,stroke:#c62828,stroke-width:2px
    classDef evm fill:#e1f5fe,stroke:#01579b,stroke-width:2px
    classDef phevm fill:#fff3e0,stroke:#e65100,stroke-width:2px
    classDef assertions fill:#e8f5e8,stroke:#2e7d32,stroke-width:2px
    classDef tx fill:#f3e5f5,stroke:#6a1b9a,stroke-width:2px
    classDef result fill:#fff8e1,stroke:#f57c00,stroke-width:2px
