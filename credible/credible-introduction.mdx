...
<Note>
If you want to get started right away, jump directly to the [Quickstart Guide](/credible/pcl-quickstart).

For a collection of concrete assertion examples go to the [Assertions Book](/assertions-book/assertions-book-intro).
</Note>
...
- [Quickstart Guide](/credible/pcl-quickstart) - Write and deploy your first assertion using the Credible Layer CLI
