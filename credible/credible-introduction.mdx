...
- **No throughput degradation**: Assertions are executed in parallel during sequencing. We tested a 30M gas block with 1s blocktime and we ran 1B gas of assertions
