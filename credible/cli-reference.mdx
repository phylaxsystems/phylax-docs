...
Submit [assertions](/credible/glossary#assertion) to the [Phylax platform](https://app.phylax.systems).

```bash
Arguments for submitting assertions to the Phylax platform
...
Options:
  -u, --api-url <API Endpoint>   Base URL for the Phylax platform API [env: PCL_API_URL=] [default: https://app.phylax.systems/api/v1]
...
Base URL for the [Phylax platform](https://app.phylax.systems) API. Default: `https://app.phylax.systems/api/v1`
