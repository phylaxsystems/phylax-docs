...
<Note>
`pcl test` supports all Forge test options. See the [Forge test documentation](https://book.getfoundry.sh/reference/forge/forge-test) for additional options.
</Note>
...
<Note>
If you're using [`ph.getAssertionAdopter()`](/credible/cheatcodes-reference#getassertionadopter) in your assertion contract and aren't adding any additional contract state variables to your assertion contract, you don't need to provide constructor arguments when storing the assertion.
</Note>
