...
<Note>
If you are ready to execute deployment, use [Deploy Assertions with the dApp](./deploy-assertions-dapp). If you need background on how the system works, start with the [Architecture Overview](./architecture-overview).
</Note>
