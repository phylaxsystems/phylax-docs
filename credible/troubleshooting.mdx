...
- "Unknown Revert Reason" with gas cost near the active assertion limit in backtesting results
...
For local replay configuration and result fields, see the [Backtesting Reference](./backtesting-reference). To investigate a finding from a platform release check, see [How to Review Backtesting Results](./backtesting).
