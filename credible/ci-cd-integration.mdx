...
Foundry profiles allow you to configure different compilation and testing settings for different parts of your project. For assertions, you typically want separate profiles for unit and fuzz tests so slower suites do not run every time you want quick local feedback.
...
- [Review Backtesting Results](/credible/backtesting) - Review the automatic backtest attached to a platform release
