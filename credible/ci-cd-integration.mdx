...
## Running Tests Locally with Profile

You can set the `FOUNDRY_PROFILE` environment variable to `assertions` when running tests locally:
...
5. **Pin versions** - Consider pinning PCL CLI version for reproducibility
