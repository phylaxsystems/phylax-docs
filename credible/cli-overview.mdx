...
4. **Deploy**: Complete the deployment process in the dApp by linking the assertion contract to your protocol's contract. After the timelock period, the assertion will be enforced and begin protecting your contract. See the [dApp Guide](/credible/dapp-guide#linking-assertions-to-your-project) for details.
