...
### What is Phylax Explorer?
Phylax Explorer is the public interface for reviewing protocol protection posture. It can show active assertions, release-generated protection summaries, operational risk cards, deployed-vs-audited code context, evidence links, raw data views, and limited invalidation metadata where those fields are available.

It is useful for end users, allocators, and risk teams because they can review what protections and evidence a protocol has made visible. Developers can also use it to learn from assertions used by protocols with similar contracts.

**Learn More:**
- [Deploy Assertions](/credible/deploy-assertions-dapp)
- [Glossary - Phylax Explorer](/credible/glossary#phylax-explorer)
...
You can inspect public assertion posture in Phylax Explorer. Some project and invalidation details are only visible to project managers and collaborators.

**Learn More:**
- [Assertions Book](/assertions-book/assertions-book-intro)
- [Phylax Explorer](/credible/dapp-explorer)
...
OP Stack integrations define a validation policy for L1-originated deposits as part of the network integration. The policy specifies where assertion validation runs, how results are routed to sequencing components, and which invalidation metadata is sent to affected protocols.
