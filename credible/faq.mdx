...
- [How It Works](/credible/how-it-works) - Technical deep dive
...
- [How It Works - System Components](/credible/how-it-works#system-components)
...
- [How It Works - Assertion Validation](/credible/how-it-works#assertion-validation-process)
...
**Learn More:**
- [Credible Layer Overview - Why Neutrality Matters](/credible/credible-layer-overview#why-neutrality-matters)
- [Architecture](/credible/architecture)
...
**Learn More:**
- [Writing Assertions Guide](/credible/pcl-assertion-guide)
- [Assertion Patterns](/credible/assertion-patterns)
...
**Learn More:**
- [How It Works - Assertion Validation Process](/credible/how-it-works#assertion-validation-process)
- [How It Works - Transaction Flow](/credible/how-it-works#transaction-flow)
...
**Learn More:**
- [dApp Guide](/credible/dapp-guide)
- [CLI Reference Guide](/credible/pcl-reference-guide)
...
**Learn More:**
- [Architecture - Abstract Overview](/credible/architecture#abstract-overview)
...
**Learn More:**
- [How It Works - PhEVM](/credible/how-it-works#phevm-phylax-evm)
- [Architecture](/credible/architecture)
...
**Learn More:**
- [Architecture - OP Stack Implementation](/credible/architecture#op-stack-implementation)
...
As mentioned above in [How do you extend the validation logic of the sequencer to the dApp?](#how-do-you-extend-the-validation-logic-of-the-sequencer-to-the-dapp), the Credible Layer is functionally middleware as it enables the sequencer to remove transactions that would break the dApp's rules.
...
**Learn More:**
- [Architecture - Abstract Overview](/credible/architecture#abstract-overview)
- [How It Works - High-Level Architecture](/credible/how-it-works#high-level-architecture)
