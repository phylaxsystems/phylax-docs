...
### Setup
- We assume you've already installed the Credible Layer CLI (`pcl`) and have a project set up. If you don't have one set up yet, you can follow the [pcl quickstart guide](/credible/pcl-quickstart) to get started.
...
<Note>
This was generated in April 2025. The testing interface has changed since then to only use `cl.assertion()`. See the [Testing Assertions](/credible/testing-assertions) guide for the current interface.
</Note>
