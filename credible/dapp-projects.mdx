...
<Frame caption="Reviewing and deploying a release">
  <video controls playsInline preload="metadata" aria-label="Release review and deployment walkthrough" style={{ width: "100%" }}>
    <source src="/images/release-review.mp4" type="video/mp4" />
  </video>
</Frame>
