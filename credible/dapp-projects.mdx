...
7. Check whether any fields are inconclusive or stale before relying on a page in The Phylax Explorer for review.

The Phylax Explorer is most useful when the project's evidence is current. If a protocol upgrades contracts, adds assertions, removes assertions, changes governance authority, or publishes a new audit, review the project metadata.
