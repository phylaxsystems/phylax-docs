...
<Frame caption="Phylax comes bundled with pre-release checks and backtesting against thousands of blocks to reduce the chance of erroneous deployment, forgotten triggers or misconfiguration.">
  <img src="/images/release-review-verification.png" alt="Assertion verification showing a passed assertion, its adopter contract, and function-call triggers" />
</Frame>

<Frame caption="Review backtesting findings and matched historical transactions">
  <img src="/images/release-review-backtesting.png" alt="Release backtesting result showing a historical transaction that would have been invalidated by the assertion set" />
</Frame>
