...
This resource is a collection of use cases and patterns for assertions. The goal is to show how assertions can be used to prevent hacks and vulnerabilities in popular smart contracts and protocols.
Some examples are concrete for specific protocols, while others are more generally focused on popular patterns.
There's also a category for previous hacks where we show how assertions could have been used to prevent the hacks.
