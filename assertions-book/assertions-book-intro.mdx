...
If you have any questions or issues getting things to work please reach out on telegram [@phylax_monitor](https://t.me/phylax_monitor).
...
For the actual example listed above see the [Owner Change](assertions/ass5-ownership-change.mdx) assertion.
