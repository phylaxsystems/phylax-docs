...
- [**Rate-of-Change Circuit Breakers**](./rate-of-change-circuit-breakers): Explains how experimental peak, latest, and mean flow rates help distinguish sudden ERC20 movements from gradual ones after a cumulative threshold is crossed.
