...
- [**`outflowRate` and `inflowRate`**](./rate-of-change-circuit-breakers): Reference for the experimental peak, latest, and mean rate contexts exposed to cumulative flow assertions.
