...
- **[BaseInvariants](https://github.com/phylaxsystems/aave-v3-origin/tree/main/assertions/src/production/BaseInvariants.t.sol)** - Cross-transaction accounting validation:
...
- **[OracleAssertions](https://github.com/phylaxsystems/aave-v3-origin/tree/main/assertions/src/production/OracleAssertions.t.sol)** - Price manipulation detection:
...
- **[FlashloanInvariantAssertions](https://github.com/phylaxsystems/aave-v3-origin/tree/main/assertions/src/production/FlashloanInvariantAssertions.t.sol)** - Flashloan security:
...
- **[LogBasedAssertions](https://github.com/phylaxsystems/aave-v3-origin/tree/main/assertions/src/production/LogBasedAssertions.t.sol)** - Proxy/delegatecall resilient validation:
...
- **[BorrowingInvariantAssertions](https://github.com/phylaxsystems/aave-v3-origin/tree/main/assertions/src/showcase/BorrowingInvariantAssertions.t.sol)** - Standard borrow checks:
...
- **[LendingInvariantAssertions](https://github.com/phylaxsystems/aave-v3-origin/tree/main/assertions/src/showcase/LendingInvariantAssertions.t.sol)** - Standard supply/withdrawal checks:
  - Reserve state validation
  - Supply cap enforcement
  - Balance change verification
  - Collateral withdrawal health

- **[LiquidationInvariantAssertions](https://github.com/phylaxsystems/aave-v3-origin/tree/main/assertions/src/showcase/LiquidationInvariantAssertions.t.sol)** - Standard liquidation checks:
...
- **[HealthFactorAssertions](https://github.com/phylaxsystems/aave-v3-origin/tree/main/assertions/src/showcase/HealthFactorAssertions.t.sol)** - Health factor transitions:
...
- **[BorrowLogicErrorAssertion](https://github.com/phylaxsystems/aave-v3-origin/tree/main/assertions/srcshowcase/BorrowLogicErrorAssertion.t.sol)** - Simple balance validation:
